...
import ClientTaskCalendar from "../components/ClientTaskCalendar";
...
export default function ClientDetailPage() {
  ...
  const { clients, addNoteToClient, deleteNoteFromClient } = useCrmStore();
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      {/* Header */}
      <div>
        <h2 className="text-3xl font-bold text-text-main dark:text-text-main2">{client.name}</h2>
      ...
      {/* Tasks Section  */}
    <ClientTaskList clientId={clientId} />
    <ClientTaskCalendar clientId={clientId} />
    </div>
  );
}